...
LiF_DDB_fnames = [ pjoin(LiF_datadir, fname) for fname in """
                    odat_calc_DS8_DDB.nc
                    odat_calc_DS12_DDB.nc
                    odat_calc_DS16_DDB.nc
                    """.split() ]

LiF_EIG_fnames = [ pjoin(LiF_datadir, fname) for fname in """
                    odat_calc_DS9_EIG.nc
                    odat_calc_DS13_EIG.nc
                    odat_calc_DS17_EIG.nc
                    """.split() ]

LiF_EIGR2D_fnames = [ pjoin(LiF_datadir, fname) for fname in """
                    odat_calc_DS10_EIGR2D.nc
                    odat_calc_DS14_EIGR2D.nc
                    odat_calc_DS18_EIGR2D.nc
                   """.split() ]

LiF_EIGI2D_fnames = [ pjoin(LiF_datadir, fname) for fname in """
                    odat_calc_DS10_EIGI2D.nc
                    odat_calc_DS14_EIGI2D.nc
                    odat_calc_DS18_EIGI2D.nc
                   """.split() ]

LiF_FAN_fnames = [ pjoin(LiF_datadir, fname) for fname in """
                    odat_calc_DS10_FAN.nc
                    odat_calc_DS14_FAN.nc
